                ...
                <div class="components-preview wide-sm mx-auto">
                    <div class="nk-block-head nk-block-head-lg wide-xl">
                        <div class="nk-block-head-content">
                            <h2 class="nk-block-title fw-normal text-center" style="font-family: Georgia;">Sell
                                {{ request()->session()->get('sell_amount') }}
                                {{ request()->session()->get('crypto_abbr') }} For
                                {{ request()->session()->get('sell_price') }} USD</h2>
                        </div>
                    </div><!-- .nk-block-head -->
                    <center>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-lg">
                    ...
                    <form action="{{ route('customer.i_have_paid') }}" id="paid-form" method="POST">
                        @csrf
                    <div class="nk-block">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control form-control-lg"
                                       name="address" id="address" placeholder="Enter your wallet address">
                                </div>
                            </div>
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#paid-form').on('submit', function(e) {
